...
let test_summate _ =
  ...
  assert_equal (summate 10)
    55 (* note a semicolon is illegal here - OCaml oddity *)
...
let test_iota1 _ =
  ...
  assert_equal (iota1 7) [ 7; 6; 5; 4; 3; 2; 1 ]
...
let test_rotate_list _ =
  assert_equal (rotate_list [ 1; 2; 3; 4; 5 ] 3) [ 3; 4; 5; 1; 2 ]
...
let test_merge_sort _ =
  ...
  assert_equal (merge_sort [ 1; 7; 6; 3; 4; 5; 2 ]) [ 1; 2; 3; 4; 5; 6; 7 ]
...
let test_is_prime _ =
  ...
  assert_equal (is_prime 100) false;
...
let part2_section2_tests =
  ...
  >::: [
         ...
         "Prime Factor with Greatest Multiplicity"
         >:: test_prime_factor_with_greatest_multiplicity;
       ]

(* Part II Section 3 *)
let tower_board_example_2x2 = [ [ 1; 2 ]; [ 2; 1 ] ]
let tower_board_ill_formed_example_2x2 = [ [ 1; 2 ]; [ 2; 2 ] ]
let tower_board_not_square_example = [ [ 1; 2; 3 ]; [ 2; 1 ] ]
let tower_board_example_3x3 = [ [ 1; 2; 3 ]; [ 3; 1; 2 ]; [ 2; 3; 1 ] ]
...
let tower_board_ill_formed_3x3 = [ [ 1; 2; 3 ]; [ 3; 2; 1 ]; [ 2; 3; 1 ] ]
...
let test_transpose _ =
  ...
  assert_equal
    (transpose tower_board_example_3x3)
    tower_board_example_transposed_3x3

let test_reflect_vertical_axis _ =
  assert_equal
    (reflect_vertical_axis tower_board_example_2x2)
    [ [ 2; 1 ]; [ 1; 2 ] ];

  assert_equal
    (reflect_vertical_axis tower_board_example_3x3)
    tower_board_example_reflected_3x3

(* A useful invariant: four rotations is a no-op *)
let test_rotate_ccw _ =
  assert_equal
    (tower_board_example_2x2 |> rotate_ccw |> rotate_ccw |> rotate_ccw
   |> rotate_ccw)
    tower_board_example_2x2;
  assert_equal
    (rotate_ccw tower_board_example_3x3)
    [ [ 3; 2; 1 ]; [ 2; 1; 3 ]; [ 1; 3; 2 ] ]
